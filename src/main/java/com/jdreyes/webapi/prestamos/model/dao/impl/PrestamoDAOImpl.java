...
public class PrestamoDAOImpl extends BaseQueryExecutor implements PrestamoDAO {
    ...
    @Override
    public void save(Integer idCLiente, String fechaApertura, BigDecimal monto, Integer tasaInteres, Short plazo, String codigo, int... dias) {
        createStoredProcedureQuery("Sp_Graba_Prestamos")
                ...
                .registerStoredProcedureParameter(6, Short.class, ParameterMode.IN)
                ...
                .setParameter(13,  dias[6])
                .setParameter(14,  codigo)
                .execute();
    }
}
